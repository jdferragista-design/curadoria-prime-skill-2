...
| `/nintendo-switch-lite-review-2026/` | REVIEW — **PRONTO_PARA_REVISAO** · novo review individual do produto-âncora do cluster (Switch Lite, hub do guia de games) · arquivo em `articles/html_output/nintendo-switch-lite-review-2026.html` · gerado com `gerar_artigo.py` v2.0 (--tipo review) · preço R$ 1.366,67 Amazon / R$ 1.366,64 ML · nota 8,5/10 Régua · 1.851 palavras · aprovado no checker (0 erros) · JSON-LD Review+FAQPage · links confirmados pelo editor: link.amazon/B06MejMa2 + meli.la/2mReGbQ |
| `/mario-kart-8-deluxe-review-2026/` | REVIEW — **PRONTO_PARA_REVISAO** · review individual do 2º item do hub de games · arquivo em `articles/html_output/mario-kart-8-deluxe-review-2026.html` · gerado com `gerar_artigo.py` v2.0 (--tipo review) · preço R$ 324,57 Amazon / R$ 309 ML · nota 9,0/10 Régua · 1.659 palavras · aprovado no checker (0 erros) · JSON-LD Review+FAQPage · links confirmados pelo editor: link.amazon/B028hyTBk + meli.la/2PhrCHL · LEDGER já tinha capturas (duplicata rejeitada) |
